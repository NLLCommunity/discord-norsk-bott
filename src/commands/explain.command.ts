...
export class ExplainCommand {
  ...
  async handle(
    ...
    try {
      ...
      const header = `> ⚠️ **Note:** This explanation is generated by an AI model and may not be accurate or vary each time it is generated. For the most accurate information, please ask a human expert.
